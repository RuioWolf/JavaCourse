							...
							<table width="200" border="0" bordercolor="#99CCFF"
								...
								<%
									...
									try {
										...
										String sql = "select p_id,p_name,p_price,p_image,p_description from product where p_type='"
												+ select_type + "' and p_name like '%" + select_p_name + "%'";
										rs = conn.doQuery(sql);
									} catch (Exception e) {
									}
