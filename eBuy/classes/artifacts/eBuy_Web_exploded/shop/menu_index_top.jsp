		...
		<table width="782" border="1" bordercolor="#99CCFF" cellpadding="0"
			...
			<tr>
				<td width="184" height="245" valign="top">
					...
					<table width="184" border="0" bordercolor="#99CCFF" cellpadding="0"
						cellspacing="0" style="border-collapse: collapse">
						<!--DWLayoutTable-->
						<tr>
							<td height="7" align="left" valign="baseline"><jsp:include
									page="login.jsp" flush="true" /></td>
						</tr>
						<tr>
				...
				<td width="592" rowspan="5" align="center" valign="top"><table
						width="100%" border="0" cellpadding="0" cellspacing="0">
						<!--DWLayoutTable-->
						<tr>
							<td width="200" height="30" align="center"
								background="../images/logo/back_new.gif"><span
								class="STYLE2">&nbsp;新品上架</span></td>
							...
							<center>
								<table width="200" border="0" bordercolor="#99CCFF"
									...
									<tr>
										...
										%>
										<td width="110" height="135" align="center" valign="middle"><img
											src="../<%=p_image%>" width="90" /></td>
										<td width="100" align="center"><p class="STYLE5">============</p>
											...
											<p>
												<a href="#"
													onClick="window.open('view_product.jsp?p_id=<%=p_id%>','help','scrollbars=yes,resizable=yes,width=600,height=520')"><input
													name="see" type="button" class="STYLE1" value="详情"></a>
												<%
