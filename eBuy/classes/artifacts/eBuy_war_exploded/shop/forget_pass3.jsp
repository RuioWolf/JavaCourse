...
<center>
	...
	<table width="300" border="1" bordercolor="#99CCFF" style="border-collapse:collapse" cellpadding="0"
	       cellspacing="0">
		<!--DWLayoutTable-->
		<tr bgcolor="#99CCFF">
			<td height="13">&nbsp;</td>
		...
		<tr>
			<td height="60" align="center"><span class="STYLE10">答案错误<span class="STYLE11">！</span>返回请重新输入<span
					class="STYLE11">！</span></span></td>
		</tr>
	</table>
</center>
<% } else
...
<center>
	<table width="439" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td width="211" height="34" align="left" class="STYLE2"><%= c_name %>
			</td>
		</tr>
		<tr>
			<td height="34" align="right"><span class="STYLE1">密&nbsp;&nbsp;码</span>：</td>
			<td height="34" align="left" class="STYLE2"><%= c_pass %>
			</td>
		</tr>
		<tr>
			<td height="13" colspan="3" align="right"><input type="button" class="STYLE1" value=" 返回登录>>> "
